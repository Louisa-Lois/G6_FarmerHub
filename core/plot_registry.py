...
CURRENT_YEAR = 2026
# Relative to the directory uvicorn is run from (backend project root),
# matching the convention core/yield_service.py already uses -- NOT
# relative to this file's own location. A relative path here is resolved
# against the process's working directory, not core/, so "../data/..."
# would incorrectly look one level above the project root.
